...
const receitas = [
  ...
  },
  {
    ...
    ingredientes: [ "4 ovos", "2 xícaras de açúcar", "2 xícaras de farinha", "1 xícara de chocolate em pó", "1 xícara de óleo", "1 xícara de leite", "1 colher de fermento" ],
    modoPreparo: [ "1. Bata os ovos com o açúcar", "2. Adicione os ingredientes secos", "3. Adicione os líquidos", "4. Por último o fermento", "5. Asse em forno médio por 40 minutos" ]
  }
];
    ...
    <FlatList
      ...
      renderItem={({ item }) => (
        <Card style={styles.card}>
          <Card.Title title={item.nome} subtitle={`Preparo: ${item.tempoPreparo} | Porções: ${item.porcoes}`} />
          <Card.Cover source={{ uri: item.imagem }} />
          <Card.Actions>
            <Button onPress={() => navigation.navigate('Receita', { receita: item })}>Ver Detalhes</Button>
          </Card.Actions>
        </Card>
      )}
    />
